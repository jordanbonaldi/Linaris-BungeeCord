...
import net.neferett.linaris.commands.administration.CommandVersion;
import net.neferett.linaris.commands.administration.PlayerDataConsoleCommand;
import net.neferett.linaris.commands.administration.ReloadConfig;
import net.neferett.linaris.commands.administration.ShopManagerCommand;
import net.neferett.linaris.commands.administration.StopCommand;
...
import net.neferett.linaris.commands.player.CommandHelp;
import net.neferett.linaris.commands.player.CommandList;
import net.neferett.linaris.commands.player.CommandNews;
import net.neferett.linaris.commands.player.CommandReport;
import net.neferett.linaris.commands.player.CommandStaff;
import net.neferett.linaris.commands.player.MessageCommand;
import net.neferett.linaris.commands.player.RespondCommand;
